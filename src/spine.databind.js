...
(function() {
  var Attribute, Checked, Click, Controller, Cookie, DataBind, ElementBound, Enable, Hash, Options, SelectedOptions, Spine, Update, Visible,
  ...
  ElementBound = (function() {
    ...
    ElementBound.prototype.bind = function(controller, key, target, change, execute) {
      var binder, unbinder,
        _this = this;
  ...
  Hash = (function() {
    ...
    Hash.disable = function(callback) {
      if (this.enabled) {
        this.enabled = false;
        try {
          return callback();
    ...
    Hash.prototype.bind = function(controller, key, target, change, execute) {
      var hash;
      if (!this.hashbind) {
        this.hashbind = (function() {
          ...
          return function(controller, key, target, change, execute) {
            var _this = this;
      ...
      this.hashbind(controller, key, target, change, execute);
      hash = Hash.parse();
  ...
  Controller = (function(_super) {
    ...
    function Controller(args) {
      ...
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        binder = _ref[_i];
        binder.instance.bind(this.controller, binder.key, binder.target, this.change, this.execute);
        ...
        if (binder.instance.set != null) {
          if (this.json != null) {
            _results.push((function() {
              ...
              for (property in _ref1) {
                if (!__hasProp.call(_ref1, property)) continue;
                _results1.push(set(this.json[property], property));
              }
              return _results1;
            }).call(this));
          } else {
            _results.push(set(this.property));
          }
        } else {
    ...
    Controller.prototype.change = function(target, value) {
      var changed, current;
      if (typeof value === "undefined") {
        return;
      }
      current = this.get();
      if (!this.eql(current, value)) {
        changed = this.set(value);
        if (changed) {
          return this.changed.push(target);
        }
      }
    };
  ...
  DataBind = {
    ...
    refreshBindings: function(model) {
      ...
      addElement = function(instances, info, property) {
        var binder, findByProperty, instance;
      ...
      bindingElements = function(instances) {
        return function(property) {
          return instances.filter(function(instance) {
            return instances.property === property;
          }).map(function(result) {
            var binder, _i, _len, _ref;
            _ref = result.binders;
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
