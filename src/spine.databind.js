...
(function() {
  var Attribute, Checked, Click, Controller, DataBind, Enable, Hash, Options, Spine, Template, Update, Visible,
  ...
  DataBind = {
    binders: [new Update(), new Options(), new Click(), new Enable(), new Visible(), new Attribute(), new Checked(), new Hash()],
